...
//!
//! In this port the application logic (`process_packet`) runs at a lower
//! priority and the USB logic runs at higher priority. This keep the USB core
//! logic responsive to USB events generated by the host and reduces the chance
//! of missing USB events / packets.
